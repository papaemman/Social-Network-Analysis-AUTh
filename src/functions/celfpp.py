...
#         node_data = Node(node)
#         node_data.mg1 = independent_cascade(graph, [], node)
#         node_data.prev_best = cur_best
#         if cur_best is not None:
#             node_data.mg2 = independent_cascade(graph, [node], cur_best)
#         else:
...
#         else:
#             before = independent_cascade(G, S, None)
#             S.add(node_data.node)
#             after = independent_cascade(G, S, None)
